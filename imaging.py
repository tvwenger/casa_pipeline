...
def setup(vis='',config=None,uvtaper=False):
    ...
    if uvtaper:
        # automasking with taper
        cp["contpbmask"] = config.getfloat("Mask Taper","contpbmask")
        cp["contsidelobethreshold"] = config.getfloat("Mask Taper","contsidelobethreshold")
        cp["contnoisethreshold"] = config.getfloat("Mask Taper","contnoisethreshold")
        cp["contlownoisethreshold"] = config.getfloat("Mask Taper","contlownoisethreshold")
        cp["contnegativethreshold"] = config.getfloat("Mask Taper","contnegativethreshold")
        cp["contsmoothfactor"] = config.getfloat("Mask Taper","contsmoothfactor")
        cp["contminbeamfrac"] = config.getfloat("Mask Taper","contminbeamfrac")
        cp["contcutthreshold"] = config.getfloat("Mask Taper","contcutthreshold")
        cp["contgrowiterations"] = config.getint("Mask Taper","contgrowiterations")
        cp["linepbmask"] = config.getfloat("Mask Taper","linepbmask")
        cp["linesidelobethreshold"] = config.getfloat("Mask Taper","linesidelobethreshold")
        cp["linenoisethreshold"] = config.getfloat("Mask Taper","linenoisethreshold")
        cp["linelownoisethreshold"] = config.getfloat("Mask Taper","linelownoisethreshold")
        cp["linenegativethreshold"] = config.getfloat("Mask Taper","linenegativethreshold")
        cp["linesmoothfactor"] = config.getfloat("Mask Taper","linesmoothfactor")
        cp["lineminbeamfrac"] = config.getfloat("Mask Taper","lineminbeamfrac")
        cp["linecutthreshold"] = config.getfloat("Mask Taper","linecutthreshold")
        cp["linegrowiterations"] = config.getint("Mask Taper","linegrowiterations")
    else:
        # automasking without taper
        cp["contpbmask"] = config.getfloat("Mask NoTaper","contpbmask")
        cp["contsidelobethreshold"] = config.getfloat("Mask NoTaper","contsidelobethreshold")
        cp["contnoisethreshold"] = config.getfloat("Mask NoTaper","contnoisethreshold")
        cp["contlownoisethreshold"] = config.getfloat("Mask NoTaper","contlownoisethreshold")
        cp["contnegativethreshold"] = config.getfloat("Mask NoTaper","contnegativethreshold")
        cp["contsmoothfactor"] = config.getfloat("Mask NoTaper","contsmoothfactor")
        cp["contminbeamfrac"] = config.getfloat("Mask NoTaper","contminbeamfrac")
        cp["contcutthreshold"] = config.getfloat("Mask NoTaper","contcutthreshold")
        cp["contgrowiterations"] = config.getint("Mask NoTaper","contgrowiterations")
        cp["linepbmask"] = config.getfloat("Mask NoTaper","linepbmask")
        cp["linesidelobethreshold"] = config.getfloat("Mask NoTaper","linesidelobethreshold")
        cp["linenoisethreshold"] = config.getfloat("Mask NoTaper","linenoisethreshold")
        cp["linelownoisethreshold"] = config.getfloat("Mask NoTaper","linelownoisethreshold")
        cp["linenegativethreshold"] = config.getfloat("Mask NoTaper","linenegativethreshold")
        cp["linesmoothfactor"] = config.getfloat("Mask NoTaper","linesmoothfactor")
        cp["lineminbeamfrac"] = config.getfloat("Mask NoTaper","lineminbeamfrac")
        cp["linecutthreshold"] = config.getfloat("Mask NoTaper","linecutthreshold")
        cp["linegrowiterations"] = config.getint("Mask NoTaper","linegrowiterations")
